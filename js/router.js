...
(function () {
  ...
  var routes = [
    ...
    { name: "bookings", re: /^\/bookings\/?$/, params: function () { return {}; } },
    { name: "booking", re: /^\/bookings\/([^/]+)\/?$/, params: function (m) { return { id: m[1] }; } },
    { name: "my-listings", re: /^\/my-listings\/?$/, params: function () { return {}; } },
