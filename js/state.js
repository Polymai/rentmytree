...
(function () {
  ...
  var state = {
    ...
    authReady: false, // true once the initial session restore has been attempted
    ...
    // owner's message-unlock payments (per listing + season)
    myUnlocks: [],

    // booking detail page
    activeBooking: null,
    activeBookingThread: null, // the contact_request (with replies) for this booking
